...
class DFourthTableViewCell: UITableViewCell {
    @IBOutlet weak var four_like: UILabel!
    
    @IBOutlet weak var four_desc: UILabel!
    @IBOutlet weak var four_name: UILabel!
    @IBOutlet weak var four_image_logo: UIImageView!
